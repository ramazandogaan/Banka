...
////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case 3:
                    ...
                    break;
                case 0:
                    System.out.println("Çıkıl Yapılıyor...");
                    return;
                default:
    ...
    public void addCustomer() {
        ...
        Customer newCustomer = new Customer(customerId, name, soyisim, sehir);

        customers.put(customerId, newCustomer);
        System.out.println("Müşteri Başarıyla Eklendi. Müsteri ID: " + customerId);
    ...
    public void openNewAccount(Customer customer) {
        ...
        for (AccountType acc : AccountType.values()) {
            System.out.println(acc.getAccaountType());
        }

        String hesapturu = scanner.nextLine();
        AccountType selectedType = null;

        for (AccountType acc : AccountType.values()) {
            if (acc.getAccaountType().equalsIgnoreCase(hesapturu)) {
                selectedType = acc;
                break;
            }
        }
        ...
        if (selectedType != null) {
            ...
            Account newAccount = new Account(accountId, customer.getCustomerId(), selectedType);
    ...
    public void depositToAccount(Customer customer) {
        ...
        Account account = getAccountById(accountIds);
